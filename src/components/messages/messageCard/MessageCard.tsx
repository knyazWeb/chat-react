...
const MessageCard = ({name, lastMessage, lastMessageTime, chatId}: MessageCardProps) => {
  ...
  return (
    <div onClick={navigateUserToChat} className="w-full flex p-2 pl-3 justify-between items-center gap-2 shadow-md shadow-slate-300 bg-white border-t-slate-200 rounded-lg cursor-pointer hover:bg-slate-100 duration-200 ease-in-out dark:bg-darkCard dark:hover:bg-neutral-700 dark:shadow-neutral-600">
